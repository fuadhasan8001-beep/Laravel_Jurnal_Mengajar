...
@section('content')
    <div class="page-head"><div><h1>Selamat datang, {{ auth()->user()->name }}</h1><p>Pantau aktivitas akademik dan proses verifikasi dari satu tempat.</p></div><a class="btn" href="{{ route('dispensasi.index') }}">Buka verifikasi</a></div>
    <div class="stats">
    ...
    <section class="panel"><div class="panel-head"><h2>Akses cepat</h2><span class="eyebrow">Operasional hari ini</span></div><div class="panel-body"><div class="quick-grid"><a class="quick-card" href="{{ route('dispensasi.index') }}"><strong>Verifikasi dispensasi</strong><span>Tinjau pengajuan siswa yang masuk</span></a><a class="quick-card" href="{{ route('absensi.index') }}"><strong>Kelola absensi</strong><span>Periksa status kehadiran kelas</span></a></div></div></section>
@endsection