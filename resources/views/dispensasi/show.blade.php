...
@section('content')
    <div class="page-head">
        <div>
            ...
            <p>Periksa informasi pengajuan dan jejak verifikasinya.</p>
        </div><a
            class="btn btn-muted"
        ...
        <div class="panel-body">
            <dl class="detail-grid">
                <div class="detail-item">
                    <dt>Siswa</dt>
                    <dd>{{ $dispensasi->siswa->nama_siswa }} ({{ $dispensasi->siswa->nis }})</dd>
                </div>
                <div class="detail-item">
                    <dt>Tanggal</dt>
                    <dd>{{ $dispensasi->tanggal->format('d M Y') }}</dd>
                </div>
                <div class="detail-item">
                    <dt>Waktu</dt>
        ...
        <section class="panel form-panel">
            <div class="panel-head">
                <h2>Ambil keputusan</h2><span class="eyebrow">Tahap
                    {{ $dispensasi->status_piket === 'Disetujui' ? 'kedua' : 'pertama' }}</span>
            </div>
            <div class="panel-body">
                <form
                    action="{{ route('dispensasi.verify', $dispensasi) }}"
                    method="POST"
                >
                    @csrf
                    <div class="form-grid">
                        <div class="field"><label for="status">Keputusan</label><select
                                id="status"
                                name="status"
                                required
                            >
                        ...
                        <div class="field full"><label for="catatan_verifikasi">Catatan</label>
                            <textarea
